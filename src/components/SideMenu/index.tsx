...
const SideMenu: FunctionComponent<Props> = memo(({ isVisible, onToggle }) => {
  return (
    <div className={classes.container} data-visible={isVisible}>
      ...
      <div>
        ...
        />
        <SideMenuPlayers title="Rogues" className={[ClassName.Rogue]} image={CLASS_IMAGES.Rogue} />
        <SideMenuPlayers title="Droods" className={[ClassName.Druid]} image={CLASS_IMAGES.Druid} />
        <SideMenuPlayers
          title="Priests"
